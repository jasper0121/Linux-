...
### 執行結果
![image](https://hackmd.io/_uploads/rJpwOK5eyl.png)
1. 進入**Test copy on write in child之前**，除了parent和child的pid不一樣之外，因global_a變數沒有改變，故虛擬地址和實體地址的值都一樣。
2. 進入**Test copy on write in child之後**，因為global_a變數在child被改成789，但parent的global_a仍是123，因此<font color=red>**child將原本指向的global_a = 123複製到另一個實體位址後，再將其改成789**</font>，因此可以發現此時的實體位址已經改變了。

---

## Question 2：Page Fault
:::spoiler 題目敘述
